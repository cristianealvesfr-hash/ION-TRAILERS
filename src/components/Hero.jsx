            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start w-full">
                  <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="w-[280px] sm:w-auto bg-ion-bronze hover:bg-white text-ion-dark font-bold py-3 sm:py-2 px-2 sm:px-6 rounded uppercase tracking-wider transition-all duration-300 shadow-lg hover:shadow-xl text-center text-[11px] sm:text-sm">
                    Solicitar Orçamento
                  </a>
                  <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="w-[280px] sm:w-auto border-2 border-ion-dark text-ion-dark hover:bg-ion-dark hover:text-white font-bold py-3 sm:py-2 px-2 sm:px-6 rounded uppercase tracking-wider transition-all duration-300 text-center text-[11px] sm:text-sm">
                    Detalhes
                  </a>
                </div>
              </motion.div>

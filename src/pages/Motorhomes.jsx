  ...
  return (
    ...
    >
      <h1 className="text-4xl md:text-5xl font-black text-ion-dark mb-8 text-center uppercase">
        Linha <span className="text-ion-bronze">Motorhomes</span>
      </h1>
      
      <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 text-lg">
        Transformação completa de veículos em casas sobre rodas, com acabamento de alto padrão e soluções inteligentes de espaço.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="w-full aspect-video rounded-xl overflow-hidden shadow-2xl col-span-1 md:col-span-2 max-w-4xl mx-auto">
          <img 
            src="/src/assets/images/motorhome_premium.jpg" 
            alt="Motorhome Íon Trailer" 
